...
> HTML / CSS & JavaScript this project is created to get the title and author of the books and show the data through the screen from localStorage. Used JavaScript class and object with array.
...
```sh
  cd my-folder
  git clone https://github.com/abdullah97-pro/Awesome-books-refactor-classes/tree/addAwesomeBookClass
```
<!-- INSTALL -->
...
```sh
    cd Awesome-books-refactor-classes
    npm install
```
